...
static const std::string PLUGIN_NAME = "Steam Rich Presence";
...
extern "C" DLL_EXPORT void SocialPlugin_v1_GetInfo(OpenTTD_SocialPlugin_v1_PluginInfo *plugin_info)
{
    static OpenTTD_SocialPlugin_v1_PluginInfo info {
